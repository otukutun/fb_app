...
設問文:<?php echo h($res['response']['MoridaiQuestion']['question']); ?><br />
<ul style="list-style-type: none;">
<li><label><input type="radio" name="choice" value="1"/><?php echo h($res['response']['MoridaiQuestion']['option1']); ?></label></li>
<li><label><input type="radio" name="choice" value="2"/><?php echo h($res['response']['MoridaiQuestion']['option2']); ?></label></li>
<li><label><input type="radio" name="choice" value="3"/><?php echo h($res['response']['MoridaiQuestion']['option3']); ?></label></li>
<li><label><input type="radio" name="choice" value="4"/><?php echo h($res['response']['MoridaiQuestion']['option4']); ?></label></li>
</ul>
